...
<html lang="en">
    <head>
        ...
        <title>Alliance E-Learning System | Manage User Type</title>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <form:form class="form-horizontal" role="form" method="POST" 
                                           action="usertypeactions.htm" commandName="tempType">
                                        <tr>
                                            <td>User Type ID</td>
                                            <td><form:input path="userTypeId" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <td>User Type Name</td>
                                            <td><form:input path="userType" type="text" class="form-control"/></td>
                                        <tr>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                ...
                                <c:forEach items="${userTypes}" var="temp">
                                <tr>
                                    <td>${temp.getUserType()}</td>
                                    <td>${temp.getUserTypeId()}</td>                                    
                                </tr>
                                </c:forEach>
                         </table>           
                    </div>
